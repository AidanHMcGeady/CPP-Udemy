...
/*
This is an exercise to fix non-compiling code and correct comments.
You can go back to previous iterations of uploads to see the original exercise.
*/
...
main()
{
	...
	//This console output is supposed to show the result of 2+2 equation
}
